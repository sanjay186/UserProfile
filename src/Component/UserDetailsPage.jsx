...
const UserDetailsPage = ({users})=>{
  ...
  useEffect(() => {
    ...
    return(
    <div>
   { isDataFetched && <> <Typography variant="h4"align="center" sx={{marginTop:5}}>User Details</Typography>
        ...
        <Paper elevation={3} style={{ padding: '20px' }}>
          <Grid container spacing={3} alignItems="center">
            ...
            <Grid item={true} >
              ...
              <Typography>Twitter handle :  {userDetail.twitter_username===null?"N/A":userDetail.twitter_username}</Typography>
              <Typography> company :  {userDetail.company===null?"N/A":userDetail.company}</Typography>
            </Grid>
          </Grid>
          <Typography variant="h6" style={{ marginTop: '20px' }}>Profile Details</Typography>
